...
export enum ErrorMessage {
  ...
  MissingTokenHCOMIC = '缺少 HComic 登录凭据，请先在插件页登录（账号密码或 WebView）',
  AuthFailHCOMIC = 'HComic 登录态失效，请在插件页重新登录（账号密码或 WebView）',
  MissingApiKeyNH = '缺少 nhentai API Key，请先在插件页配置（nhentai 账户设置页生成）',
  AuthFailNH = 'nhentai API Key 无效或已失效，请重新配置',
